...
import dauroi.photoeditor.horizontalListView.util.MultiChoiceModeListener;
import dauroi.photoeditor.horizontalListView.util.MultiChoiceModeWrapper;
import dauroi.photoeditor.horizontalListView.util.ViewHelperFactory;
import dauroi.photoeditor.horizontalListView.util.ViewHelperFactory.ViewHelper;
...
public abstract class AbsHListView extends AdapterView<ListAdapter> implements
		...
		if (mode != OVER_SCROLL_NEVER) {
			if (mEdgeGlowTop == null) {
				...
				mEdgeGlowTop = new EdgeEffect(context,
						EdgeEffect.DIRECTION_HORIZONTAL);
		...
		if (mChoiceMode != ListView.CHOICE_MODE_NONE) {
			...
			if (mChoiceMode == ListView.CHOICE_MODE_MULTIPLE
					|| (android.os.Build.VERSION.SDK_INT >= 11
							&& mChoiceMode == ListView.CHOICE_MODE_MULTIPLE_MODAL && mChoiceActionMode != null)) {
	 ...
	 * {@link dauroi.photoeditor.horizontalListView.widget.AbsHListView.OnScrollListener}
	...
	private class FlingRunnable implements Runnable {
		 ...
		 */
		private final dauroi.photoeditor.horizontalListView.widget.OverScroller mScroller;
	 ...
	 *            recycler.
	 * 
	 * @see dauroi.photoeditor.horizontalListView.widget.AbsHListView.RecycleBin
	 * @see dauroi.photoeditor.horizontalListView.widget.AbsHListView.RecyclerListener
	 */
	 ...
	 * 
	 * @see dauroi.photoeditor.horizontalListView.widget.AbsHListView.RecycleBin
	 * @see dauroi.photoeditor.horizontalListView.widget.AbsHListView#setRecyclerListener(dauroi.photoeditor.horizontalListView.widget.AbsHListView.RecyclerListener)
	 */
