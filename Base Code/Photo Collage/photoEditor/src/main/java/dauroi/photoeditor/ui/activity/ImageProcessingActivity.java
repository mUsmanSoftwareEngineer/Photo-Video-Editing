...
public class ImageProcessingActivity extends BaseAdActivity {
    ...
    private static  int DEFAULT_SELECTED_ACTION_INDEX = 1;
    public static final String IMAGE_URI_KEY = "imageUri";
    public static final String ACTION_KEY = "actionkeyyy";
    ...
    private String actionKey = "filters";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionKey = getIntent().getStringExtra(ACTION_KEY);
    ...
    private void initInfo() {
        ...
        Log.d("4747", "initInfo: "+actionKey);
       if (actionKey != null){
           if (actionKey.equals("filters")){
               DEFAULT_SELECTED_ACTION_INDEX =0;
           }else if(actionKey.equals("crop")){
               DEFAULT_SELECTED_ACTION_INDEX =1;
           }else if(actionKey.equals("rotate")){
               DEFAULT_SELECTED_ACTION_INDEX =2;
           }else if(actionKey.equals("frame")){
               DEFAULT_SELECTED_ACTION_INDEX =4;
           }
       }
                    ...
                    .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                        ...
                        public void onGlobalLayout() {
                            ...
                            if (out.heightPixels >= out.widthPixels) {
                                if (mImageUri != null) {
//                                   Bitmap map = Glide.with(ImageProcessingActivity.this).load(mImageUri).asBitmap().toBytes();
