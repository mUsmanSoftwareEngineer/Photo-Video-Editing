...
public class FrameImageView extends FrameLayout {
    ...
    public interface OnImageClickListener {
        ...
        void onSingleClickImage(FrameImageView view);
    }
    ...
    public FrameImageView(final Context context, PhotoItem photoItem) {
        ...
        mGestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                if (mOnImageClickListener != null) {
                    mOnImageClickListener.onSingleClickImage(FrameImageView.this);
                }
                return true;
            }
        });
...
//        FrameView frameView = new FrameView(getContext(),this);
//        frameView.setForeground(drawable);
//
//        invalidate();
//    }
...
//            mImageMatrix.setScale(1,1);
//            mScaleMatrix.setTranslate(mImage.getWidth()/9,mImage.getHeight()/9);
        }
    ...
    public boolean isSelected(float x, float y) {
        ...
        ALog.d(TAG, "isSelected, x=" + x + ", y=" + y + ", result=" + result);
        return result;
    }
