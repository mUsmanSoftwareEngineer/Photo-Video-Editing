...
public class ItemImageView extends FrameLayout {
    ...
    public interface OnImageClickListener {
        ...
        void onSingleeClickImage(ItemImageView view);
...
//   constructor for server images
//    public ItemImageView(Context context, PhotoItem photoItem, Bitmap bitmap) {
//        super(context);
      ...
      //  setScaleType(ScaleType.MATRIX);
        ...
        mGestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                if (mOnImageClickListener != null) {
                    mOnImageClickListener.onSingleeClickImage(ItemImageView.this);
                }
                return true;
...
//    }
    ...
    public void recycleImages(boolean recycleMainImage) {
        ALog.d(TAG, "recycleImages, recycleMainImage=" + recycleMainImage);
        if (recycleMainImage) {
            recycleMainImage();
        }
        recycleMaskImage();
