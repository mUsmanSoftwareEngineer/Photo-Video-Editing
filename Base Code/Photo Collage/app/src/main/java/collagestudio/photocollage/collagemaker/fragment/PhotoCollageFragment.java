...
public class PhotoCollageFragment extends BaseFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        back = rootView.findViewById(R.id.main_back);
        save = rootView.findViewById(R.id.main_Save);
        backBtn = rootView.findViewById(R.id.iv_back);
        saveBtn = rootView.findViewById(R.id.tv_save);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mAddImageView != null) {
                    ...
                    mAddImageView.setAnimation(mAnimation);
                }
...
//        }
    ...
    public void clickInfoView() {
        ...
        mGuideDialog.show();
        //if you want to implement the whole procedure for the developer you have to repeat the cause. in this way wu
    }
            ...
            protected void onPostExecute(File file) {
                ...
                if (file != null) {
                    if (mShareImageListener != null) {
                        ...
                        Toast.makeText(mActivity, "Photo Saved in Gallary", Toast.LENGTH_SHORT).show();
                    }
