...
import collagestudio.photocollage.collagemaker.activity.AdsFragmentActivity;
import collagestudio.photocollage.collagemaker.activity.Constant;
import collagestudio.photocollage.collagemaker.activity.MainActivity;

public class IntroScreens extends AdsFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceManager.getDefaultSharedPreferences(IntroScreens.this)
...
//            dots[i].setTextColor(getResources().getColor(R.color.textColorSecondary));
    ...
    private void loadActivity(Class startClass) {
        Intent intent = new Intent(IntroScreens.this, startClass);
